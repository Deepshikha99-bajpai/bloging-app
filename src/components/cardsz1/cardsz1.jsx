...
import styles from "./cardsz1.module.css"; // Ensure correct relative path
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.textContainer}>
        ...
        <Link href="/" >
          <h1 className={styles.title}>welcome to the college libraray </h1>
        </Link>
        ...
        <Link href="/collib2" className={styles.link}>Read More</Link>
